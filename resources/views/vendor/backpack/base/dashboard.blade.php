        ...
        $admin_widgets = [
            [
                ...
                'content' => [
                    ...
                    'body' =>
                        "<a class='h1 d-block py-5 m-0 text-white' href='" .
                        backpack_url('course') .
                        "' ><i class='nav-icon la la-campground'></i>" .
            ...
            [
                ...
                'content' => [
                    // 'header' => 'Some card title', // optional
                    'body' =>
                        "<a class='h1 d-block py-5 m-0 text-dark' href='" .
                        backpack_url('payment') .
            ...
            [
                ...
                'content' => [
                    ...
                    'body' =>
                        "<a class='h1 d-block py-5 m-0 text-white' href='" .
                        backpack_url('classroom') .
                        "' ><i class='nav-icon la la-chalkboard-teacher'></i>" .
                        trans('classroom.classrooms') .
                        '</a>',
                ],
            ],
        ];
            ...
            'content' => [
                ...
                [
                    ...
                    'content' => [
                        ...
                        'body' =>
                            "<a class='h1 d-block py-5 m-0 text-white' href='" .
                            backpack_url('add_attend_by_date') .
                            "' ><i class='nav-icon la la-check-square'></i>" .
                            trans('attend.add_attend_w_date') .
                            '</a>',
                    ],
                ],
            ], // widgets end
