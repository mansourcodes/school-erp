                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6 col-md-4">
                                ...
                                <div class="form-control h-auto">
                                    {{ $date->locale('ar')->dayName . $date->format(' d ') . $date->locale('ar')->monthName . $date->format(' Y') }}
                                </div>
                            </div>
                            <div class="form-group col-6 col-md-4">
                                <label>{{ __('classroom.start_time') }} </label>
                                <div class="form-control h-auto">{{ $start_time->format('H:m') }}
                                    {{ __('base.' . $start_time->format('a')) }}
                                </div>
                            </div>

                            <div class="form-group col-6 col-md-6">
                                <label>{{ __('classroom.classroom') }} </label>
                                <div class="form-control h-auto">{{ $classroom->first_long_name }}</div>
                            </div>
                            <div class="form-group col-6 col-md-6">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="switch attend-switch switch-pill switch-success">
                                        <input class="switch-input" type="radio" value="attend"
                                            name="student_attend_state[{{ $student->id }}]" checked><span
                                            class="switch-slider">{{ __('attend.student_attended') }}</span>
                                    </label>
                                </td>
                                ...
                                <td>
                                    <label class="switch attend-switch switch-pill switch-late">
                                        <input class="switch-input" type="radio" value="late"
                                            name="student_attend_state[{{ $student->id }}]"><span
                                            class="switch-slider">{{ __('attend.student_late') }}</span>
                                    </label>
                                    <label class="switch attend-switch switch-pill switch-late_w_excuse">
                                        <input class="switch-input" type="radio" value="late_w_excuse"
                                            name="student_attend_state[{{ $student->id }}]"><span
                                            class="switch-slider">{{ __('attend.student_late_w_excuse') }}</span>
                                    </label>
                                </td>
                                ...
                                <td>
                                    <label class="switch attend-switch switch-pill switch-absent">
                                        <input class="switch-input" type="radio" value="absent"
                                            name="student_attend_state[{{ $student->id }}]"><span
                                            class="switch-slider">{{ __('attend.student_absent') }}</span>
                                    </label>
                                    <label class="switch attend-switch switch-pill switch-absent_w_excuse">
                                        <input class="switch-input" type="radio" value="absent_w_excuse"
                                            name="student_attend_state[{{ $student->id }}]"><span
                                            class="switch-slider">{{ __('attend.student_absent_w_excuse') }}</span>
                                    </label>
                                </td>
